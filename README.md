Slack API in Go [![Go Reference](https://pkg.go.dev/badge/github.com/gideonw/slack.svg)](https://pkg.go.dev/github.com/gideonw/slack)
===============
...
See [CHANGELOG.md](https://github.com/gideonw/slack/blob/master/CHANGELOG.md) or [Releases](https://github.com/gideonw/slack/releases) for more information about the changes.

## Installing

### *go get*

    $ go get -u github.com/gideonw/slack
...
See https://github.com/gideonw/slack/blob/master/examples/socketmode/socketmode.go
...
See https://github.com/gideonw/slack/blob/master/examples/websocket/websocket.go


## Minimal EventsAPI usage:

See https://github.com/gideonw/slack/blob/master/examples/eventsapi/events.go
